...
### ❌ WebSocket подключается к порту 5173 вместо 3000?

→ См. **[FIX_WEBSOCKET_PORT.md](FIX_WEBSOCKET_PORT.md)** 🔌

**Это исправлено автоматически!** Просто перезагрузите страницу.
