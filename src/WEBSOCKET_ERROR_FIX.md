...
### Шаг 0: Backend на другой машине?

**⚠️ ВАЖНО:** Если ваш backend сервер находится **НЕ на localhost**, а на другой машине:

→ **См. [FIX_REMOTE_BACKEND.md](FIX_REMOTE_BACKEND.md)** 🌐

**Краткое решение:**
1. Создайте файл `.env` в корне проекта frontend
2. Добавьте: `VITE_API_URL=http://IP_BACKEND_СЕРВЕРА:3000/v1`
