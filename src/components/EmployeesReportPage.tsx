    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Информация о проходах сотрудников через контрольные точки</p>
        </div>
          ...
          <table className="w-full">
            <thead style={{ backgroundColor: '#00aeef' }}>
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-white">Должность</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-white">Отдел</th>
