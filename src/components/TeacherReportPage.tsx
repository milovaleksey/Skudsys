            ...
            <div>
              <div className="flex gap-4">
                ...
                <div className="flex-1 overflow-x-auto">
                  <div className="flex gap-3">
                    {teacherData.map(dayData => (
                      <div key={dayData.date} style={{ minWidth: '140px', width: '140px' }}>
                ...
                <div className="flex-1 overflow-x-auto">
                  <div className="flex gap-3">
                    {teacherData.map(dayData => {
                      ...
                      const days = ['Вс', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб'];
                      return (
                        <div key={dayData.date} className="text-center p-2 bg-gray-50 rounded-lg" style={{ minWidth: '140px', width: '140px' }}>
